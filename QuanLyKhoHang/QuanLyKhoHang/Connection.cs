...
namespace QuanLyKhoHang
{
    class Connection
    {
        ...
        {
            string sql = @"Data Source=DESKTOP-76IRRSL\SQLEXPRESS;Initial Catalog=QLKH;Integrated Security=True";
        ...
        public SqlCommand Tang_SoLuong(string masp, int soluongmoi)
        {
            OpenConnect();
            cmd = new SqlCommand("TANG_SOLUONGSANPHAM", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@MASP", masp));
        ...
        public SqlCommand Giam_SoLuong(string masp, int soluongmoi)
        {
            OpenConnect();
            cmd = new SqlCommand("GIAM_SOLUONGSANPHAM", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@MASP", masp));
            cmd.Parameters.Add(new SqlParameter("@SOLUONGMOI", soluongmoi));
            cmd.ExecuteNonQuery();
