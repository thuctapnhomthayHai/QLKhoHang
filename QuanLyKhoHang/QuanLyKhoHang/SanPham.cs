...
namespace QuanLyKhoHang
{
    public partial class SANPHAM : Form
    {
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            if (key == 1)
            {
                if (tbx_tensp.Text == "" || txb_madm.Text == "" || txb_ncc.Text == "" || txb_phanloai.Text == "" || txb_serial.Text == "")
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        acc.Tang_SoLuong(tbx_masp.Text, Convert.ToInt32(txb_soluong.Value));
                        SANPHAM_Load(sender, e);
                        cleartext();
                        dgv_SANPHAM.ClearSelection();
        ...
        {
            if (Convert.ToInt32(txb_soluong.Text) > 2000)
            {
                MessageBox.Show("Không Thể Nhập Nhiều Hơn 2000SP!", "Lỗi!");
                txb_soluong.ResetText();
            }
        }
